...
public class Defaults {
	...
	public static native boolean asPrimitiveBoolean(JavaScriptObject jsValue) throws JsonizerException /*-{
		...
		@org.juglar.gwt.jsonizer.client.base.Defaults::throwJsonizerException()();
	}-*/;
	...
	private static class A_IntJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_IntJsonizer::createArray(I)(jsValue.length);
				
			var i;
			for(i in jsValue){		
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_IntJsonizer::storeValue([IILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
	...
	private static class A_LongJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_LongJsonizer::createArray(I)(jsValue.length);
				
			var i;
			for(i in jsValue){
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_LongJsonizer::storeValue([JILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
	...
	private static class A_FloatJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_FloatJsonizer::createArray(I)(jsValue.length);
				
			var i;
			for(i in jsValue){
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_FloatJsonizer::storeValue([FILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
	...
	private static class A_DoubleJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_DoubleJsonizer::createArray(I)(jsValue.length);
				
			var i;
			for(i in jsValue){
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_DoubleJsonizer::storeValue([DILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
	...
	private static class A_ByteJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_ByteJsonizer::createArray(I)(jsValue.length);
				
			var i;
			for(i in jsValue){
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_ByteJsonizer::storeValue([BILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
	...
	private static class A_CharJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_CharJsonizer::createArray(I)(jsValue.length);
				
			var i;
			for(i in jsValue){
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_CharJsonizer::storeValue([CILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
	...
	private static class A_ShortJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_ShortJsonizer::createArray(I)(jsValue.length);
				
			var i;
			for(i in jsValue){
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_ShortJsonizer::storeValue([SILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
	...
	private static class A_BooleanJsonizer implements Jsonizer{			
		...
		public native Object asJavaObject(JavaScriptObject jsValue) throws JsonizerException /*-{
			...
			var javaArray = @org.juglar.gwt.jsonizer.client.base.Defaults.A_BooleanJsonizer::createArray(I)(jsValue.length);	
			var i;
			for(i in jsValue){
				@org.juglar.gwt.jsonizer.client.base.Defaults.A_BooleanJsonizer::storeValue([ZILcom/google/gwt/core/client/JavaScriptObject;)(javaArray, parseInt(i), Object(jsValue[i]));
			}			
