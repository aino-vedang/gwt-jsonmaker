...
public class HashMapJsonizer implements Jsonizer{
	...
	private native Map storeMap(JavaScriptObject jsObject)/*-{
		var map = this.@org.juglar.gwt.jsonizer.client.base.HashMapJsonizer::createMap()();
		var jsonizer = this.@org.juglar.gwt.jsonizer.client.base.HashMapJsonizer::elemJsonizer;
		var i;
		for(i in jsObject){
			...
			if(rawValue == null)
				...
				if(typeof rawValue != 'string')
					finalValue = jsonizer.@org.juglar.gwt.jsonizer.client.Jsonizer::asJavaObject(Lcom/google/gwt/core/client/JavaScriptObject;)(Object(rawValue));
				else
					finalValue = @org.juglar.gwt.jsonizer.client.base.Defaults::asPrimitiveString(Ljava/lang/String;)(rawValue);
			}
