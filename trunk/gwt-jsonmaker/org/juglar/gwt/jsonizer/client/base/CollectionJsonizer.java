...
public abstract class CollectionJsonizer implements Jsonizer {
	...
	private native Collection storeCollection(JavaScriptObject jsArray) throws JsonizerException/*-{
		var javaArray = this.@org.juglar.gwt.jsonizer.client.base.CollectionJsonizer::createCollection()();
		var elemJsonizer = this.@org.juglar.gwt.jsonizer.client.base.CollectionJsonizer::elemJsonizer;
		...
		for(var i = 0; i < jsArray.length; i++){
			...
			if(rawValue == null){
				...
				if(typeof rawValue != 'string')
					finalValue = elemJsonizer.@org.juglar.gwt.jsonizer.client.Jsonizer::asJavaObject(Lcom/google/gwt/core/client/JavaScriptObject;)(Object(rawValue));
				else
					finalValue = @org.juglar.gwt.jsonizer.client.base.Defaults::asPrimitiveString(Ljava/lang/String;)(rawValue);//gaurav
			}
